...
public class JhmunTestMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("3) Volunter 추상 클래스 만들기");
		//JhmunVolunteer volunteer1 = new JhmunVolunteer("김길동 어린이 돕기",5);
		
		System.out.println("4) Donation (물적기부) 개체 만들기");
		...
		greenjoa.addVolunteer(new JhmunTalentDonation("섬마을 미용 봉사활동",2,"미용기술"));
